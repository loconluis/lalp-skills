...
- **Intent before interface, spec before code.** If you can't state the intent in one paragraph a stranger would understand, you're not ready to code. (`../../disciplines/intent-spec/SKILL.md`)
