...
Division of labor: the intent spec (`../intent-spec/SKILL.md`) owns **why and what**; the sketch owns **the shape**. Architect runs after the spec gate.
