...
Unattended hours. The unit of progress is a **verified unit on disk**, not a good feeling (`../../principles/sequence-units/SKILL.md`, `../../principles/never-block/SKILL.md`).
...
Every unit ends with its own evidence on disk — tests, runs, screenshots — before the next begins. Green build ≠ proof (`../../disciplines/prove-it-works/SKILL.md`). A unit that can't be verified isn't done; it's blocked, and it goes in the report as such.
