...
Attack the **dominant cost** only. Smallest change that removes it (`../../principles/smallest-change/SKILL.md`), kept reviewable — a 40% win inside a readable diff beats a 45% win inside a rewrite.
